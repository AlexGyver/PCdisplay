...
- 1.4 от 28.01.2018 - исправлен баг с временем работы (спасибо Ивану Булгакову)
- 1.5 от 28.01.2018 - добавлена настройка "выключать подсветку при потере связи"
...
- **PCdisplay_v.1.5** - прошивка для Arduino, для дисплея 2004, файл в папке открыть в Arduino IDE ([инструкция](#chapter-4))
- **PCdisplay_v_1.5_1602** - прошивка для Arduino, для дисплея 1602, файл в папке открыть в Arduino IDE ([инструкция](#chapter-4))
